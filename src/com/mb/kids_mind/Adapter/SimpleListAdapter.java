...
public class SimpleListAdapter extends BaseAdapter {
	...
	int size;
	String a=null;
	List<Integer> list0,list1,list2,list3,list4,list5,list6,list7,list8,list9;
			...
			public void onClick(View view) {
				...
				checklist = new ArrayList<String>();
					...
					case 9:
						...
						Log.v(TAG,"size"+size10+"");
						//doSetList(size,list0,position);
						if(size10!=0){
							//list0=new LinkedList<Integer>();

							for(int i=1;i<size10+1;i++){
								if(!list9.contains(position)){
									list9.add(position);
						...
						for (int i = 0; i < list9.size(); i++) {
							Log.v(TAG, "평상시" + list9.get(i).intValue() + "");
							str10 += list9.get(i).intValue() + "" + ",";
						}
						Log.v(TAG, "strstr" + str10);
						editor.putString("list10", str10);
						editor.commit();
						//			}
...
//	}
	void setHashMap(){
		...
		map.put("d099.png",R.drawable.d099);
		map.put("d100.png",R.drawable.d100);
		map.put("d101.png",R.drawable.d087);
		map.put("d102.png",R.drawable.d088);
		map.put("d103.png",R.drawable.d089);
		map.put("d104.png",R.drawable.d090);
		map.put("d105.png",R.drawable.d091);
		map.put("d106.png",R.drawable.d093);
		map.put("d107.png",R.drawable.d094);
		map.put("d108.png",R.drawable.d095);
		map.put("d109.png",R.drawable.d096);
		map.put("d110.png",R.drawable.d097);
		map.put("d111.png",R.drawable.d098);
		map.put("d112.png",R.drawable.d099);
		map.put("d113.png",R.drawable.d100);
		map.put("d114.png",R.drawable.d101);
		map.put("d115.png",R.drawable.d102);
		map.put("d116.png",R.drawable.d103);
		map.put("d117.png",R.drawable.d104);
		map.put("d118.png",R.drawable.d105);
		map.put("d119.png",R.drawable.d106);
		map.put("d120.png",R.drawable.d107);
